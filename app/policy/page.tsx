    ...
    <main className='min-h-screen bg-slate-50 text-slate-900'>
      <div className='mx-auto max-w-3xl px-6 py-16 space-y-12'>
        <header>
          ...
          <p className='mt-3 text-base text-slate-600'>このページでは本チャットボットに適用されるプライバシーポリシーと利用規約のみを掲載しています。</p>
        </header>
        ...
        <section className='space-y-4'>
          ...
          <p className='text-base leading-relaxed text-slate-700'>
            ...
            当社は、当社が提供する AI チャットボットサービス「TOM FLUX チャットボット」（以下「本サービス」といいます）をご利用いただくお客様その他のユーザーの皆さま（以下「ユーザーの皆さま」といいます。）について、個人情報保護法第2条第1項に定める個人情報のうち、氏名、連絡先（電話番号およびメールアドレス）、生年月日のみを、下記の目的の範囲内で利用いたします。
          ...
          <p className='text-base leading-relaxed text-slate-700'>
            取得したデータは第三者へ提供しません。ただし、法律に基づき開示が必要と判断される場合を除きます。
          </p>
        </section>
